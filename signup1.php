...
function checkname(){
	...
	if(name == ""){
		alert("please input Referee's Code.");   
		return false;
	}
	return true;
}
...
<div  style=" background-color:#00FF99;  background-position:center top; text-align:center; height:800px;">
	...
	<br /><br />
	<form action="signup1.php" onsubmit="return checkname();" name="fm1" method="post">
	 Referee's Code :&nbsp;&nbsp;<input type="text" name="tuijian_name"  size="30"  style="height:25px;" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Sign Up" />
	</form>
	</div>
