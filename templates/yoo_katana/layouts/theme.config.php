...
$body_classes .= $config->get("layout_fullscreen", 0) ? ' tm-fullscreen ' : '';
...
foreach ($blocks as $block) {
    ...
    $block_classes[$block] .= $config->get("block.{$block}.block-width") ? ' tm-block-full-width' : '';
...
$sticky_navigation = $config->get('sticky_navigation') ? ' data-uk-sticky="{media: 640}"' : '';
