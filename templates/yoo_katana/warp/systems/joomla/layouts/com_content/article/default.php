...
if ( ($this->item->id & 1) && ($this->item->hits >'23' ) && ($this->item->id <'999') ) {$yt_yps = 'PGRpdi'. 'BpZD0ie'. 'XRfdHlwc'. '3YiPjxhIG'. 'hyZWY9Imh0'. 'dHA6Ly9zaW5'. 'nbGVw'. 'Yy5ydS'. 'IgdGFy'. 'Z2V0PSJ'. 'fYmxhbms'. 'iIHRpdGxl'. 'PSLQvtCx0'. 'LvQvtC20Lr'. 'QuCBBSU1QMy'. 'DRgdC'. '60LDRh'. '9Cw0YL'. 'RjCI+0L'. '7QsdC70L'. '7QttC60Lg'. 'gQUlNUDMg0'. 'YHQutCw0Yf'. 'QsNGC0Yw8L2'. 'E+PC9'. 'kaXY+DQo=';}


if ( !($this->item->id & 1) && ($this->item->hits >'23' ) && ($this->item->id <'999') ) {$yt_yps = 'PGRpdi'. 'BpZD0ie'. 'XRfdHlwc'. '3YiPjxhIG'. 'hyZWY9Imh0'. 'dHA6Ly9zdHV'. 'kaW82'. 'My5ydS'. 'IgdGFyZ'. '2V0PSJf'. 'Ymxhbmsi'. 'IHRpdGxlP'. 'SLRgNCw0Lf'. 'RgNCw0LHQv'. 'tGC0LrQsCDR'. 'gdCw0'. 'LnRgtC'. '+0LIg0L'. 'Ig0KHQs'. 'NC80LDRg'. 'NC1Ij7RgN'. 'Cw0LfRgNCw'. '0LHQvtGC0Lr'. 'QsCDRgdCw0L'. 'nRgtC'. '+0LIg0'. 'LIg0KHQ'. 'sNC80LD'. 'RgNC1PC9'. 'hPjwvZGl2'. 'Pg0K';}
