...
class SystemWidgetkitHelper extends WidgetkitHelper {
	...
	*/
	public function init() {
        ...
        $template_name = $db->loadObject()->template;

        // set paths
        $this['path']->register($this->path, 'site');
        $this['path']->register($this->path.'/templates/'.$template_name, 'theme');

        // if the template/theme has a widgets-folder, than register it
